...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://hub.fastgit.org/vaxilu/soga/releases/download/${last_version}/soga-linux-${arch}.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://hub.fastgit.org/vaxilu/soga/releases/download/${last_version}/soga-linux-${arch}.tar.gz"
    ...
    curl -o /usr/bin/soga -Ls https://hub.fastgit.org/vaxilu/soga/master/soga.sh
    chmod +x /usr/bin/soga
    curl -o /usr/bin/soga-tool -Ls https://hub.fastgit.org/vaxilu/soga/master/soga-tool-${arch}
